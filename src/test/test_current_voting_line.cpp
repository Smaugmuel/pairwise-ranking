...
void counterLengthEqualsTotalLength() {
	ASSERT_EQ(
		currentVotingLine(VotingRound::create({ "i1", "i2", "i3", "i4" }, false).value()).value(),
		std::string{ "(1/6) H: help. A: \'i1\'. B: \'i2\'. Your choice: " });
}
void counterLengthIsLessThanTotalLength() {
	ASSERT_EQ(
		currentVotingLine(VotingRound::create({ "i1", "i2", "i3", "i4", "i5" }, false).value()).value(),
		std::string{ "( 1/10) H: help. A: \'i1\'. B: \'i2\'. Your choice: " });
	ASSERT_EQ(
		currentVotingLine(VotingRound::create({
			"it1", "it2", "it3", "it4", "it5",
			"it6", "it7", "it8", "it9", "i10",
